    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#ECFDF5] via-white to-[#E0F7F4]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-18 items-center ">
          ...
          <div className="py-16">
            ...
            >
              ...
              <p className="mt-7 text-gray-600 text-lg leading-8 max-w-xl">
                ...
                experienced doctors, and receive personalized health guidance
              ...
              >
                {/* Card 1 */}
                <div className="bg-white rounded-2xl p-3 h-24 shadow-lg text-center transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:scale-105">
          ...
          <div className="lg:self-start py-40">
            <motion.div
              initial={{ opacity: 0, x: 70 }}
              animate={{ opacity: 1, x: 0 }}
